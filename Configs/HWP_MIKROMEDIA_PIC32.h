...
typedef enum
{
    ...
    ANSEL_ANALOG = 1
        ...
        #define DisplayBacklightOn()        (LATAbits.LATA9 = BACKLIGHT_ENABLE_LEVEL)
        #define DisplayBacklightOff()       (LATAbits.LATA9 = BACKLIGHT_DISABLE_LEVEL)
#endif
        // Definitions for FLASH CS pin
        #define DisplayFlashConfig()
        #define DisplayFlashEnable()
	...
	*********************************************************************/
	...
	// NOTE: GFX_PICTAIL_V3 can be paired with Explorer 16 or with PIC32 Starter Kits
	    ...
	    #define RESISTIVETOUCH_ANALOG  0
            ...
            #define ResistiveTouchScreen_XMinus_Drive_High()        LATBbits.LATB11   = 1
            #define ResistiveTouchScreen_XMinus_Drive_Low()         LATBbits.LATB11   = 0
            #define ResistiveTouchScreen_XMinus_Config_As_Input()   {AD1PCFGbits.PCFG11 = 1; TRISBbits.TRISB11 = 1;}
            #define ResistiveTouchScreen_XMinus_Config_As_Output()  {AD1PCFGbits.PCFG11 = 1; TRISBbits.TRISB11 = 0;}
