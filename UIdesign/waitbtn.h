...
#ifndef WAITBTN_H_FILE
#define WAITBTN_H_FILE
/*****************************************************************************
 * SECTION:  Includes
 *****************************************************************************/
 ...
 ***********************************/
extern const IMAGE_FLASH waitbtn;
#define waitbtn_WIDTH     (70)
#define waitbtn_HEIGHT    (80)
#define waitbtn_SIZE      (11206)
/*********************************
 * Bitmap Structure
 * Label: takebtn
 * Description:  70x80 pixels, 16-bits per pixel
 ***********************************/
extern const IMAGE_FLASH takebtn;
#define takebtn_WIDTH     (70)
#define takebtn_HEIGHT    (80)
#define takebtn_SIZE      (11206)
#endif
